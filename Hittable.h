...
struct HitRecord {
    ...
    float emission;     // emission of the intersected surface
};
...
public:
    ...
    virtual void Sample(HitRecord* hit_record, float& pdf) const = 0;
...
public:
    ...
    virtual void Sample(HitRecord* hit_record, float& pdf)const override;
